...
export interface ApiCategoryCategory extends Schema.CollectionType {
  ...
  attributes: {
    ...
    >;
    onHomepage: Attribute.Boolean & Attribute.DefaultTo<false>;
...
export interface ApiCurrencyCurrency extends Schema.CollectionType {
  ...
  attributes: {
    ...
    isBeforePrice: Attribute.Boolean &
      Attribute.Required &
      Attribute.DefaultTo<false>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiIgIg extends Schema.CollectionType {
  collectionName: 'ig';
  info: {
    singularName: 'ig';
    pluralName: 'igs';
  ...
  attributes: {
    ...
    token_type: Attribute.String & Attribute.Private;
    expires_in: Attribute.Integer & Attribute.Private;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::ig.ig', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    updatedBy: Attribute.Relation<'api::ig.ig', 'oneToOne', 'admin::user'> &
      Attribute.Private;
  };
}
...
export interface ApiParentCategoryParentCategory extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String;
    uid: Attribute.UID<'api::parent-category.parent-category', 'name'> &
      Attribute.Required &
      Attribute.SetMinMaxLength<{
        minLength: 3;
      }>;
...
export interface ApiSettingsSettings extends Schema.SingleType {
  ...
  attributes: {
    socials: Attribute.Component<'settings.social', true>;
    contact: Attribute.Component<'settings.contact'>;
    home_page: Attribute.Component<'settings.home-page'>;
    navigation: Attribute.Component<'settings.navigation'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
